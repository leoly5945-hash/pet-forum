...
/**
 * Pet Forum — language switcher + Google Translate integration.
 */
if ( file_exists( ASTRA_THEME_DIR . 'inc/language-switcher.php' ) ) {
	require_once ASTRA_THEME_DIR . 'inc/language-switcher.php';
}

/**
 * Pet Forum — hybrid homepage assets.
 */
