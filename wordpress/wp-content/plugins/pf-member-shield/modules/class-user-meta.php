...
class PF_User_Meta {
	...
	public static function enqueue_assets() {
		...
		wp_enqueue_style( 'pf-profile', PF_SHIELD_URL . 'assets/css/pf-profile.css', [], PF_SHIELD_VER );
		wp_enqueue_script( 'pf-profile', PF_SHIELD_URL . 'assets/js/pf-profile.js', [ 'jquery' ], PF_SHIELD_VER, true );
	}
